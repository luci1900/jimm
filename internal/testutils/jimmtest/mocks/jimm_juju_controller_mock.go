...
type ControllerService struct {
	...
	DestroyController_                 func(ctx context.Context, user *openfga.User, controllerName string) error
}
...
func (j *ControllerService) DestroyController(ctx context.Context, user *openfga.User, controllerName string) error {
	if j.DestroyController_ == nil {
		return errors.E(errors.CodeNotImplemented)
	}
	return j.DestroyController_(ctx, user, controllerName)
}
