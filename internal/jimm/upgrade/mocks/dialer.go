...
func (m *MockDialer) DialController(ctx context.Context, ctl *dbmodel.Controller, modelTag names.ModelTag, user *openfga.User) (juju.API, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DialController", ctx, ctl, modelTag, user)
...
func (mr *MockDialerMockRecorder) DialController(ctx, ctl, modelTag, user any) *MockDialerDialControllerCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DialController", reflect.TypeOf((*MockDialer)(nil).DialController), ctx, ctl, modelTag, user)
...
func (c *MockDialerDialControllerCall) Do(f func(context.Context, *dbmodel.Controller, names.ModelTag, *openfga.User) (juju.API, error)) *MockDialerDialControllerCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockDialerDialControllerCall) DoAndReturn(f func(context.Context, *dbmodel.Controller, names.ModelTag, *openfga.User) (juju.API, error)) *MockDialerDialControllerCall {
